...
public class Poll implements Serializable{
	...
	private static final long serialVersionUID = 7053192988421374790L;

	@Id @GeneratedValue(strategy=GenerationType.AUTO)
	@Column(name="idPoll") @NotNull
	private int id;
	...
	@JoinTable(name="PostPoll", 
	joinColumns={@JoinColumn(name="idPoll")}, inverseJoinColumns = {@JoinColumn(name="idUser")})
	...
	public String toString() {
		return "Poll [id=" + id + ", topic=" + topic + ", options=" + options
				+ ", posts=" + posts + ", visits=" + visits + ", lastPost="
				+ lastPost + ", users=" + users + "]";
	}
